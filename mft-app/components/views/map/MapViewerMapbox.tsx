/**
 * Map Viewer Mapbox Component
 *
 * Core map component that handles map rendering, marker display, and user location
 * tracking using the Mapbox SDK.
 *
 * Features:
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Mapbox.LocationPuck
          pulsing={{ isEnabled: true, color: colors.dark_red }}
        />
