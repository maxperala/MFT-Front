 ...
 * Compass Component
 *
 * A dynamic compass that rotates based on device heading, featuring a background
 * image and fixed needle overlay with smooth animations.
 *
 * Features:
 * - Smooth rotation animations using springs
 * - Redux integration for heading data
 * - Smart rotation handling across 0/360 degrees
 * - Layered background and needle images
