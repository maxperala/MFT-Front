 ...
 * Marker Component
 *
 * Displays location markers on the map with different states for discovered
 * and undiscovered postcards, including titles and custom styling.
 *
 * Features:
 * - Conditional rendering based on discovery state
 * - Random rotation for visual variety
 * - Localized title display (Finnish/English)
 * - Custom marker images for different states
 * - Redux integration for state management
 * - Interactive press handling for discovered cards
 *
 * @component
 */
