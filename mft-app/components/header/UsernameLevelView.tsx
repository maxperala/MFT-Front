/**
 * Username Level View Component
 *
 * Displays user profile information including username, level, and card collection
 * progress in a structured layout with custom styling.
 *
 * Features:
 * - Username and level display
 * - Localized content (Finnish/English)
 * - Card collection progress counter
 * - Custom font styling
